...
public class functionBlockTabs {
    ...
    public static final RegistryObject<CreativeModeTab> Function_Block_Tab = CREATIVE_MODE_TABS.register("function_block_tab",
            ...
            .icon(() -> new ItemStack(blockRegister.territory_cabinet.get()))
            .title(Component.translatable("itemGroup.function_blocks_tabs"))
            .displayItems((pParameters, pOutput) -> {pOutput.accept(blockRegister.territory_cabinet.get());
            }).build());
